...
function update(session)
{
    ...
    // Re-init local dir info when needed
    if (session.userData.localDir == null)
    {
...
function updateUserData(session)
{
    ...
    if (players && (players.length != 0) && session.userData.playerInfo && (session.userData.state != Defs.GameState.STATE_INIT))
    {
